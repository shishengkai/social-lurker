...
**轻量 R1：0.3.5 已交付，120 项本地测试与 Python 3.12/3.13 CI 通过。两平台前台通知、手机原链接、合作作品过滤和防重发已实测通过。2026-09-13 的原生纯探针、桌面及 iPhone 静默验证通过，当前两平台来源证据已补齐，正式日间任务已启用、setup check 为 automatic_ready。首轮完整自动业务仍待真实日程验收；视频号间歇故障不视为已消失，手机作品系统推送仅部分确认。**
...
| Grok Bot 后台 | 夜间门禁、原生纯探针及桌面/iPhone 静默通过；正式日间任务已启用，首轮完整自动业务待验 |
